...
- Local code review of one PR or MR, including diff inspection, targeted verification, and findings: `$git-pr-review`.
...
If intent is unclear, ask whether they want to list open review items, inspect status for one item, review one item locally, address comments, watch CI, create a new PR or MR, update an existing PR or MR, or merge.
