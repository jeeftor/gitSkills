...
SKILLS="git-workflow git-branch-sync git-issue-table git-issue-details git-issue-create git-pr git-pr-table git-pr-watcher git-pr-address-comments git-ci-watch git-pr-create git-pr-update git-pr-merge"
